...
name_list = []
id_list = []
for i in data_dict['heroes']:
	temp1 = i['localized_name'].replace(' ', '_') + ".png"
	temp2 = str(i['id'])
	new_dict.update({temp1:temp2})

#TRIVIAL 

new_dict.update({"Monkey_King.png":"114"})

print new_dict

for image in os.listdir("."):
	if image.endswith(".png"):
		os.rename(image, new_dict[image])
